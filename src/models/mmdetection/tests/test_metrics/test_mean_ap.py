import numpy as np
from mmdet.core.evaluation.mean_ap import eval_map, tpfp_default, tpfp_imagenet, tpfp_openimages
...
def test_tpfp_openimages():
    ...
    cls_dets_gt = np.array(
        [
            [28.0, 28.0, 35.0, 35.0, 0.97],
            [30.0, 30.0, 51.0, 51.0, 0.96],
            [100.0, 110.0, 120.0, 130.0, 0.15],
            [10.0, 10.0, 15.0, 15.0, 1.0],
        ],
    )
