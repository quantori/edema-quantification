...
def test_ssd_anchor_generator():
    ...
    expected_base_anchors = [
        torch.Tensor(
            [
                [-16.0000, -16.0000, 32.0000, 32.0000],
        ...
        torch.Tensor(
            [
                [-34.0000, -34.0000, 66.0000, 66.0000],
        ...
        torch.Tensor(
            [
                [-43.0000, -43.0000, 107.0000, 107.0000],
        ...
        torch.Tensor(
            [
                [-47.5000, -47.5000, 154.5000, 154.5000],
        ...
        torch.Tensor(
            [
                [-46.5000, -46.5000, 206.5000, 206.5000],
        ...
        torch.Tensor(
            [
                [8.0000, 8.0000, 312.0000, 312.0000],
    ...
    expected_base_anchors = [
        ...
        torch.Tensor(
            [
                [-14.5000, -14.5000, 30.5000, 30.5000],
        ...
        torch.Tensor(
            [
                [-33.5000, -33.5000, 65.5000, 65.5000],
        ...
        torch.Tensor(
            [
                [-44.5000, -44.5000, 108.5000, 108.5000],
        ...
        torch.Tensor(
            [
                [-53.5000, -53.5000, 153.5000, 153.5000],
        ...
        torch.Tensor(
            [
                [19.5000, 19.5000, 280.5000, 280.5000],
...
def test_yolo_anchor_generator():
    ...
    expected_base_anchors = [
        torch.Tensor(
            [
                [-42.0000, -29.0000, 74.0000, 61.0000],
        ...
        torch.Tensor(
            [
                [-7.0000, -22.5000, 23.0000, 38.5000],
...
def test_guided_anchor():
    ...
    multi_level_valid_flags = ga_retina_head.approx_anchor_generator.valid_flags(
        featmap_sizes,
        (800, 1216),
        device,
    )
    ...
    expected_squares = [
        torch.Tensor([[-16.0, -16.0, 16.0, 16.0]]),
        torch.Tensor([[-32.0, -32.0, 32.0, 32]]),
        torch.Tensor([[-64.0, -64.0, 64.0, 64.0]]),
        torch.Tensor([[-128.0, -128.0, 128.0, 128.0]]),
        torch.Tensor([[-256.0, -256.0, 256.0, 256.0]]),
    ]
