    ...
    def __init__(
        ...
        **kwarg
        ...
        super(CoarseMaskHead, self).__init__(
            *arg, num_convs=num_convs, upsample_cfg=dict(type=None), init_cfg=None, **kwarg
        )
        ...
        if downsample_factor > 1:
            downsample_in_channels = (
                self.conv_out_channels if self.num_convs > 0 else self.in_channels
            )
        ...
        self.output_size = (
            self.roi_feat_size[0] // downsample_factor,
