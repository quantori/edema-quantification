...
from blocks import ENCODERS, TransientLayers, PrototypeLayer, LastLayer
from prototype_model_utils import (
    get_encoder,
...
class EdemaNet(pl.LightningModule):
    ...
    def __init__(
        ...
        # encoder
        self.encoder = get_encoder(encoders=ENCODERS, name=settings.encoder)
