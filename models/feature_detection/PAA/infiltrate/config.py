...
data_root = 'data/coco_infiltrate'
img_norm_cfg = dict(
...
train_pipeline = [
    ...
    dict(type='Translate', level=1, max_translate_offset=64, prob=0.2),
...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='data/coco_infiltrate/train/labels.json',
        img_prefix='data/coco_infiltrate/train/data',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(
    ...
    val=dict(
        type='CocoDataset',
        ann_file='data/coco_infiltrate/test/labels.json',
        img_prefix='data/coco_infiltrate/test/data',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
seed = 11
total_epochs = 100
work_dir = 'models/feature_detection/paa_infiltrate'
auto_resume = False
gpu_ids = [0]
