...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='data/coco_effusion/train/labels.json',
        img_prefix='data/coco_effusion/train/data',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(
    ...
    val=dict(
        type='CocoDataset',
        ann_file='data/coco_effusion/test/labels.json',
        img_prefix='data/coco_effusion/test/data',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
seed = 11
total_epochs = 100
work_dir = 'models/feature_detection/paa_effusion'
auto_resume = False
gpu_ids = [0]
